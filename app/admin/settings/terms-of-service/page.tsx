...
import { FiPlus, FiEdit, FiTrash2, FiCheck, FiX, FiFileText, FiSave } from 'react-icons/fi';
  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto p-8 text-center">
        ...
        <p className="text-gray-500 mt-2">Chargement des politiques d'utilisation...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Politiques d'utilisation</h1>
          <p className="text-gray-600">Gérez les conditions d'utilisation de la plateforme.</p>
        </div>
        <button
          onClick={() => {
            setEditingTerm(null);
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Liste des politiques</h2>
        </div>
